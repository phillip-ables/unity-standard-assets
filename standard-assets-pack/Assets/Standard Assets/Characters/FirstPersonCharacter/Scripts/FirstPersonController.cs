...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void GetInput(out float speed)
        {
            ...
            //need to find what input it is using for look rotation
            float lookHorizontal = CrossPlatformInputManager.GetAxis("LookHorizontal");
            float lookVertical = CrossPlatformInputManager.GetAxis("LookVertical");
        ...
        private void RotateView()  // when is this called, cus this calls the main function from the mouslook namespace
        {
